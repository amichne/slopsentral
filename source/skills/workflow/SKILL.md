...
Review unsupported Claude skill fields manually: `- "https`, `- '\bbunx\s+workflow(?`, `- '\bnpx\s+workflow(?`, `allOf`, `anyOf`, `bashPatterns`, `docs`, `importPatterns`, `metadata`, `minScore`, `noneOf`, `pathPatterns`, `phrases`, `priority`, `promptSignals`, `sitemap`.
