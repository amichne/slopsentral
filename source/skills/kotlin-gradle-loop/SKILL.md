...
description: "Run Kotlin and Gradle build-test-fix loops through structured scripts that capture Gradle, JUnit, JaCoCo, and Kotlin compiler evidence instead of raw terminal parsing."
---
...
Review unsupported Claude skill fields manually: `loop`.
