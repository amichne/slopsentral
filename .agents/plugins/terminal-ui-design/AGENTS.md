# Terminal Ui Design Plugin Instructions

## Scope

This generated adapter applies to the `terminal-ui-design` plugin payload. Do not edit it directly; update the provider-neutral primitives or plugin manifest, then regenerate the marketplace output.
...
Design workflow for distinctive, accessible, and resilient human-facing terminal interfaces.
...
- `terminal-ui-design`: `skills/terminal-ui-design` (source: `source/skills/terminal-ui-design`)
